...
const Home = () => {
    ...
    const handleResumeChange = (e) => {
        ...
        setFileMessage(`Selected file: ${file.name}`)
    }
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <p className='dropzone__title'>
                                    {selectedResume ? "Resume selected successfully" : "Click to upload or drag & drop"}
                                </p>
                            ...
                            {fileMessage && <p className='upload-success'>{fileMessage}</p>}
                        </div>
